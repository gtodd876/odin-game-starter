...
set flags=-sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS -O3 -sALLOW_MEMORY_GROWTH -sEXPORTED_RUNTIME_METHODS=HEAPF32,HEAPU8 --shell-file source/main_web/index_template.html --preload-file assets --preload-file data
